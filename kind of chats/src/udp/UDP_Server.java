...
public abstract class UDP_Server implements Runnable{

	private final int bufferSize; // in bytes
	private final int port;
	private final Logger logger = Logger.getLogger(UDP_Server.class.getCanonicalName());
	private volatile boolean isShutDown = false;
	
	public UDP_Server(int port, int bufferSize) {
